	...
	function doAssociations(){
		...
		if(row==null||row.length==0){
			...
			$("#associationSelect").empty();
			 ...
			 $.post("${pageContext.request.contextPath}/decidedZoneAction_findassociationcustomers",{"id":row.id},function(data){
				 // List<Customer>  [{},{},{}]  option创建  associationSelect
				  $(data).each(function(){
...
<body class="easyui-layout" style="visibility:hidden;">
			...
			<form id="addDecidedZoneForm" action="${pageContext.request.contextPath}/decidedZoneAction_save" method="post">
				<table class="table-edit" width="80%" align="center">
					...
					<tr height="300">
						...
						<td>
							<table id="subareaGrid"  class="easyui-datagrid" border="false" style="width:300px;height:300px" data-options="url:'${pageContext.request.contextPath}/subareaAction_findnosociation',fitColumns:true,singleSelect:false">
								<thead>  
							        <tr>  
	...
	<div class="easyui-window" title="查询定区窗口" id="searchWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="searchForm" action="${pageContext.request.contextPath}/decidedZoneAction_pageQuery" method="post">
				<table class="table-edit" width="80%" align="center">
					<tr class="title">
					...
					<tr>
						<td>是否关联分区</td>
						<td><select type="text" name="isAssociationSubarea" class="easyui-combobox">
