 ...
 * Generated at: 2016-12-30 15:50:13 UTC
...
public final class noticebill_005fadd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t$.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/regionAction_ajaxListProvience\",function(data){\r\n");
      out.write("\t\t\t$(data).each(function(){\r\n");
      out.write("\t\t\t\t$(\"#province\").append(\"<option value='\"+this+\"'>\"+this+\"</option>\");\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$(\"#province\").change(function(){\r\n");
      out.write("\t\t\t$(\"#city\")[0].length=1;\r\n");
      out.write("\t\t\t$(\"#district\")[0].length=1;\r\n");
      out.write("\t\t\t$.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/regionAction_ajaxListCity\",{\"province\":this.value},function(data){\r\n");
      out.write("\t\t\t\t$(data).each(function(){\r\n");
      out.write("\t\t\t\t\t$(\"#city\").append(\"<option value='\"+this+\"'>\"+this+\"</option>\");\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t});\r\n");
      ...
      out.write("\t\t\t$.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/regionAction_ajaxListDistrict\",{\"city\":this.value},function(data){\r\n");
      out.write("\t\t\t\t$(data).each(function(){\r\n");
      out.write("\t\t\t\t\t$(\"#district\").append(\"<option value='\"+this+\"'>\"+this+\"</option>\");\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\t\t\t\t$(\"#station\").val(data.station);\r\n");
      ...
      out.write("\t\t\t\t\t<td>客户单位:</td>\r\n");
      out.write("\t\t\t\t\t<td><input type=\"text\" class=\"easyui-validatebox\"  name=\"station\" id=\"station\"\r\n");
      out.write("\t\t\t\t\t\trequired=\"true\" /></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td>客户姓名:</td>\r\n");
      out.write("\t\t\t\t\t<td><input type=\"text\" class=\"easyui-validatebox\" name=\"customerName\" id=\"customerName\"\r\n");
      out.write("\t\t\t\t\t\trequired=\"true\" /></td>\r\n");
      out.write("\t\t\t\t\t<td>联系人:</td>\r\n");
      ...
      out.write("\t\t\t\t\t省：<select id = \"province\" name=\"province\">\r\n");
      out.write("\t\t\t\t\t\t<option value=\"\">--请选择--</option>\r\n");
      out.write("\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t市：<select id = \"city\" name=\"city\">\r\n");
      out.write("\t\t\t\t\t\t<option value=\"\">--请选择--</option>\r\n");
      out.write("\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t区：<select id = \"district\" name=\"district\">\r\n");
      out.write("\t\t\t\t\t\t<option value=\"\">--请选择--</option>\r\n");
      out.write("\t\t\t\t\t</select>&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" class=\"easyui-validatebox\" name=\"pickaddress\"\r\n");
      out.write("\t\t\t\t\t\trequired=\"true\" size=\"76\"/></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
