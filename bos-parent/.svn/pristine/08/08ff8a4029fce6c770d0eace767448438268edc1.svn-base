...
<script type="text/javascript">
	$(function(){
		$("input[name='checkcode']").blur(function(){
			$.post("${pageContext.request.contextPath }/user/userAction_validCheckCode","",function(data){
			});
		});
	});
...
<body>
	<div
		...
		<img src="${pageContext.request.contextPath }/images/logo.png"
			...
			style="float: right; margin-top: 35px; color: #488ED5;">新BOS系统以宅急送开发的ERP系统为基础，致力于便捷、安全、稳定等方面的客户体验</span>
	</div>
			...
			<div class="loginForm">
				...
				<form id="loginform" name="loginform" method="post" class="niceform"
					...
					<div class="loginFormIpt loginFormIptWiotTh"
						...
						<a
							href="${pageContext.request.contextPath}/page_common_index.action"
							id="loginform:j_id19" name="loginform:j_id19"> <span
