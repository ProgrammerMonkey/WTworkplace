...
// Generated 2016-12-23 17:11:12 by Hibernate Tools 3.2.2.GA
...
public class Standard  implements java.io.Serializable {
    ...
    public Standard(String name, Integer minweight, Integer maxweight, Integer minlength, Integer maxlength, Date operationtime, String operator, String operatorcompany) {
       this.name = name;
